...
use crate::jsonrpc::futures::{future, Async, Future, IntoFuture, Poll, Stream};
...
use crate::{
    utils, AllowedHosts, CorsDomains, RequestMiddleware, RequestMiddlewareAction, RestApi,
};
...
impl<M: Metadata, S: Middleware<M>> IntoFuture for ServerHandler<M, S> {
